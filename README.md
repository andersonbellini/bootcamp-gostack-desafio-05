...
```
https://api.github.com/repos/xxx/unform/issues?state=all
https://api.github.com/repos/xxx/unform/issues?state=open
https://api.github.com/repos/xxx/unform/issues?state=closed
```
...
```
https://api.github.com/repos/xxxxx/unform/issues?page=2
```
